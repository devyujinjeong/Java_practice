package com.dbwls.looping_and_branching.level03.hard;
...
public class Application3 {
    public static void main(String[] args) {
        ...
        System.out.println(checkAndCountWord(s,c));

    }

    static String checkAndCountWord(String s, char c){
        int count = 0;
        ...
        for(int i=0; i<s.length(); i++){
            if((s.charAt(i)>='a'&&s.charAt(i)<='z')||(s.charAt(i)>='A'&&s.charAt(i)<='Z')){
                ...
                return "영문자가 아닌 문자가 포함되어 있습니다.";
            }
        }

        return "포함된 개수 : "+ count +"개";
    }
}
